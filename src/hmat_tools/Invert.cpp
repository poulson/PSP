...
template void psp::hmat_tools::Invert( Dense<float>& D );
template void psp::hmat_tools::Invert( Dense<double>& D );
template void psp::hmat_tools::Invert( Dense<std::complex<float> >& D );
template void psp::hmat_tools::Invert( Dense<std::complex<double> >& D );
