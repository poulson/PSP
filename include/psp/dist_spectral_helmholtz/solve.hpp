...
template<typename R>
void
DistSpectralHelmholtz<R>::PullRightHandSides
...
template<typename R>
void
DistSpectralHelmholtz<R>::PushRightHandSides
...
template<typename R>
void
DistSpectralHelmholtz<R>::InternalSolveWithGMRES
...
template<typename R>
bool
DistSpectralHelmholtz<R>::CheckForNaN( R alpha ) const
{
...
template<typename R>
bool
DistSpectralHelmholtz<R>::CheckForNaN( C alpha ) const
{
    return alpha != alpha; // hopefully this is not optimized away
}
...
template<typename R>
bool
DistSpectralHelmholtz<R>::CheckForNaN( const std::vector<R>& alphaList ) const
{
    bool foundNaN = false;
...
template<typename R>
bool
DistSpectralHelmholtz<R>::CheckForNaN( const std::vector<C>& alphaList ) const
{
    bool foundNaN = false;
    for( unsigned k=0; k<alphaList.size(); ++k )
        if( CheckForNaN(alphaList[k]) )
...
template<typename R>
bool
DistSpectralHelmholtz<R>::CheckForZero( const std::vector<R>& alphaList ) const
{
...
template<typename R>
bool
DistSpectralHelmholtz<R>::CheckForZero( const std::vector<C>& alphaList ) const
{
    bool foundZero = false;
    for( unsigned k=0; k<alphaList.size(); ++k )
...
template<typename R>
void
DistSpectralHelmholtz<R>::InnerProducts
...
template<typename R>
void
DistSpectralHelmholtz<R>::DivideColumns
...
template<typename R>
void
DistSpectralHelmholtz<R>::MultiplyColumns
...
template<typename R>
void
DistSpectralHelmholtz<R>::SubtractScaledColumns
...
template<typename R>
void
DistSpectralHelmholtz<R>::Multiply( Matrix<C>& B ) const
{
...
template<typename R>
void
DistSpectralHelmholtz<R>::Precondition( Matrix<C>& B ) const
{
...
template<typename R>
void
DistSpectralHelmholtz<R>::SolvePanel( Matrix<C>& B, int i ) const
{
...
template<typename R>
void
DistSpectralHelmholtz<R>::SubdiagonalUpdate( Matrix<C>& B, int i ) const
{
    const int commSize = mpi::CommSize( comm_ );
    const int numRhs = B.Width();
...
template<typename R>
void
DistSpectralHelmholtz<R>::ExtractPanel
( Matrix<C>& B, int i, Matrix<C>& Z ) const
{
...
template<typename R>
void
DistSpectralHelmholtz<R>::MultiplySuperdiagonal( Matrix<C>& B, int i ) const
{
    const int commSize = mpi::CommSize( comm_ );
    const int numRhs = B.Width();
...
template<typename R>
void
DistSpectralHelmholtz<R>::UpdatePanel
